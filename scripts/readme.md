...
* `download_t7_dump.py`: Retrieves the latest Xetra T7 all tradable instruments dump from the official exchange portal. Employs a web scraper to dynamically locate and download the reference CSV file.
