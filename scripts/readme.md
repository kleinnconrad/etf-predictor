...
* `build_etf_batch.py`: Evaluates the eligibility of the generated seed list. It implements a multithreaded screening process to verify a minimum trading history of five years and a minimum daily turnover of one million euros. The validated tickers are exported as a JSON batch file.
