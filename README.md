...
* **Economic Baseline:** The model applies an assumed base inflation rate (e.g., 2.5% p.a.) and a tolerance corridor of (e.g. -0.1% for down and +10.0% for up and flat else).
